...
import (
	...
	"micro-mine/application/common/baseerror"
	"micro-mine/application/common/config"
	"micro-mine/application/gateway/models"
	"micro-mine/application/imserver/protos"
...
func (l *GateWayLogic) Send(r *SendRequest) (*SendResponse, error) {
	fmt.Println("user ToToken is ", r.ToToken)
	fmt.Println("user FromToken is ", r.FromToken)
...
func (l *GateWayLogic) GetServerAddress(r *GetServerAddressRequest) (*GetServerAddressResponse, error) {
	fmt.Println("user token is ", r.Token)
